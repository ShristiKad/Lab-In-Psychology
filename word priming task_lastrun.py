...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\shreya kad\\Desktop\\ahmedabad university\\Lab In Psychology\\Word Priming Task\\word priming task_lastrun.py',
