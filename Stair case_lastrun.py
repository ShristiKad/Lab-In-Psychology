...
expName = 'Stair case'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\shreya kad\\Desktop\\ahmedabad university\\Lab In Psychology\\New folder\\Stair case_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    for thisStair in stair:
        ...
        rand_val = random()
        if rand_val > 0.5: #50:50 probability
            direction = -level
            corr_resp = 'left'
        else:
            direction = level
        ...
        thisExp.addData('key_resp.cprr',key_resp.corr)
        # check responses
